...
The following guide gives an overview of the project and some directions on how to make common types of contribution. If something is missing or you get stuck, please [jump on Slack](https://slack.aquasec.com/) or [start a discussion](https://github.com/khulnasoft-lab/defsec/discussions/new) and we'll do our best to help.
